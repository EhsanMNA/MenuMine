...
import static me.ehsanmna.menumine.utils.ReflectionUtils.supports;
            ...
            if (supports(20)) {
                if (meta instanceof ArmorMeta) {
                    ...
                    if (armorMeta.hasTrim()) {
                        org.bukkit.inventory.meta.trim.ArmorTrim trim = armorMeta.getTrim();
        ...
        if (meta instanceof SkullMeta) {
            ...
            if (supports(20)) {
                if (meta instanceof ArmorMeta) {
                    ...
                    if (config.isSet("trim")) {
                        ...
                        org.bukkit.inventory.meta.trim.TrimMaterial trimMaterial = Registry.TRIM_MATERIAL.get(NamespacedKey.fromString(trim.getString("material")));
                        org.bukkit.inventory.meta.trim.TrimPattern trimPattern = Registry.TRIM_PATTERN.get(NamespacedKey.fromString(trim.getString("pattern")));
            ...
            if (supports(17)) {
                if (meta instanceof AxolotlBucketMeta) {
                    ...
                    if (variantStr != null) {
                        org.bukkit.entity.Axolotl.Variant variant = Enums.getIfPresent(org.bukkit.entity.Axolotl.Variant.class, variantStr.toUpperCase(Locale.ENGLISH)).or(org.bukkit.entity.Axolotl.Variant.BLUE);
